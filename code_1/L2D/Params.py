...
# args for PPO - LOGIC FIX: Settings for stability
...
parser.add_argument('--gamma', type=float, default=0.99, help='discount factor') # Standard PPO gamma
...
parser.add_argument('--vloss_coef', type=float, default=0.5, help='critic loss coefficient') # Standard value
parser.add_argument('--ploss_coef', type=float, default=1.0, help='policy loss coefficient')

# Entropy start value (will be decayed in main loop)
